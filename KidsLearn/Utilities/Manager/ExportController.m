...
- (void)sendEmail:(NSDictionary *)info{
	...
	[[XCViewController sharedInstance] presentModalViewController:mailPicker animated:NO];
}
...
//    
	...
	if (!ISEMPTY(text)) {
		...
		[tweetViewController setInitialText:@"via 3in1 Kids Games"];
    ...
    [tweetViewController setCompletionHandler:^(TWTweetComposeViewControllerResult result) {
        ...
        [[XCViewController sharedInstance] dismissModalViewControllerAnimated:YES];
    }];
    
    // Present the tweet composition view controller modally.
    [[XCViewController sharedInstance] presentModalViewController:tweetViewController animated:YES];
